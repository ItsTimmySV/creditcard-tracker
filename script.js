// script.js completo para CreditCard Tracker
...
function renderCardDetails() {
    ...
    document.getElementById('usage-bar').style.width = `${Math.min(100, usage)}%`;
    document.getElementById('balance-display').textContent = `$${balance.toFixed(2)}`;
    document.getElementById('available-display').textContent = `$${availableCredit.toFixed(2)}`;
}
